            ...
            {kind === 'MCP' && (
              <div className={styles.field}>
                ...
                <FieldHint label={t('MCP server')}>
                  {t('The id of the registered MCP server this shell speaks through. Register the server on the Integrations page first - we recommend Orknux Shell - then paste its id here. A picker will replace this once installation-wide servers land; today it is the id.')}
                </FieldHint>
                <input
                  id="shell-mcp-server"
                  name="shellMcpServer"
